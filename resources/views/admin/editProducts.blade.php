    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col mt-4 px-5">
                <h4 class="h4">Update Products</h4>
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="prod_discount_price" value="{{$product->prod_discount_price}}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea rows="5" name="prod_description" class="form-control">{{$product->prod_description}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-2 mt-2 float-end">
                                <input type="submit" value="Update Products" class="btn btn-secondary">
                            </div>
                        </form>
                    </div>
                </div>
